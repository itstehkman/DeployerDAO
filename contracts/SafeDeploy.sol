...
contract SafeDeploy is Initializable, Ownable, tokenRecipient {
     ...
     * Initializer
     *
     * Must be used so that the proxy is aware of how to instantiate
     * the contract, since proxies do not know of Constructors
     * (https://docs.zeppelinos.org/docs/pattern.html#the-constructor-caveat)
     */
    function initialize(
